...
\subsubsection{Inline code} % (fold)

Inline code is also possible with the \OldTexttt{\textbackslash texttt\{\} command}. For example \texttt{this is inline code}. % subsubsection Inline Code (end)

% subsubsection Inline Code (end)
